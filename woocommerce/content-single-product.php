...
function healthy_living_related_products_args($args) {
...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( '', $product ); ?>>
		...
		<div class="summary entry-summary cmsmasters_product_right_column">
			<div class="cmsmasters_product_title_info_wrap">
				...
				<div class="cmsmasters_product_info_wrap">
					<?php 
					healthy_living_woocommerce_rating('cmsmasters_theme_icon_star_empty', 'cmsmasters_theme_icon_star_full');
	...
	<?php
		if ($cmsmasters_layout != 'fullwidth') {
			add_filter('woocommerce_output_related_products_args', 'healthy_living_related_products_args');
		}
