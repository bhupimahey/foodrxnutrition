...
echo '<div class="images cmsmasters_product_images">';
	...
	if ($product->get_image_id()) {
		...
		$html .= sprintf( '<img src="%s" alt="%s" class="wp-post-image" />', esc_url( wc_placeholder_img_src( 'woocommerce_single' ) ), esc_html__( 'Awaiting product image', 'healthy-living' ) );
		$html .= '</div>';
	}
