...
if ($best == 'true') {
	...
	if ($best_bg_color != '') {
		$this->pricing_table_items_atts['style_pricing'] .= '#cmsmasters_pricing_item_' . $unique_id . ' .cmsmasters_pricing_item_inner .pricing_title,' . 
		'#cmsmasters_pricing_item_' . $unique_id . ' .cmsmasters_pricing_item_inner .cmsmasters_price_wrap { ' . 
