...
if ($color != '') {
	$this->counters_atts['style_counters'] .= '#cmsmasters_counter_' . $unique_id . ' .cmsmasters_counter_counter_wrap { ' . 
...
$out = '<div class="cmsmasters_counter_wrap' . $this->counters_atts['counters_count'] . '">' . "\n" . 
	...
	(($icon_type == 'icon' && $icon != '') || ($icon_type == 'image' && $image != '') ? ' counter_has_icon_or_image' : '') . 
	'" data-percent="' . $value . '">' . "\n" . 
