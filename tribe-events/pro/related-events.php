...
<h2 class="tribe-events-related-events-title"><?php printf( esc_html__( 'Related %s', 'healthy-living' ), tribe_get_event_label_plural() ); ?></h2>
	...
	<li>
		...
		<div class="tribe-related-event-info">
			<div class="updated published time-details cmsmasters_events_start_date">
				<span class="cmsmasters_event_start"><?php echo tribe_get_start_date($post->ID, false, 'F d, Y'); ?></span>
			</div>
