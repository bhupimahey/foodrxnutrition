		...
		<div class="cmsmasters_single_event_header clearfix">
			...
			<div class="cmsmasters_single_event_header_right clearfix">
				<div class="tribe-events-back">
					<a class="cmsmasters_theme_icon_date" href="<?php echo esc_url( tribe_get_events_link() ); ?>"> <?php printf( esc_html__( 'All %s', 'healthy-living' ), $events_label_plural ); ?></a>
				</div>
	...
	if ($published_events > 1) {
		echo '<aside id="tribe-events-sub-nav" class="post_nav">';
			if (tribe_get_prev_event_link()) {
				...
				echo '<span class="cmsmasters_prev_arrow"><span></span></span><span class="sub">' . esc_html__('previous', 'healthy-living') . '</span></span>';
			}
			...
			if (tribe_get_next_event_link()) {
				echo '<span class="tribe-events-nav-next cmsmasters_next_post">';
					...
					echo '<span class="cmsmasters_next_arrow"><span></span></span><span class="sub">' . esc_html__('next', 'healthy-living') . '</span>' . 
				'</span>';
