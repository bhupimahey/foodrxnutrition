...
function healthy_living_theme_colors_secondary() {
...
/***************** Start {$title} CMSMASTERS Donations Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_donations_color {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_color']) . "
	}
	...
	{$rule}.cmsmasters_donations_link {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_link']) . "
	}
	...
	{$rule}.cmsmasters_donations_hover {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_hover']) . "
	}
	...
	{$rule}.cmsmasters_donations_heading {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_heading']) . "
	}
	...
	{$rule}.cmsmasters_donations_bg {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_bg']) . "
	}
	...
	{$rule}.cmsmasters_donations_alternate {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_alternate']) . "
	}
	...
	{$rule}.cmsmasters_donations_border {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_border']) . "
	}
...
/***************** Start {$title} WooCommerce Color Scheme Rules ******************/
	...
	{$rule}.out-of-stock,
	{$rule}.stock {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_color']) . "
	}
	/* Finish Main Content Font Color */
	...
	{$rule}.shop_table.shop_table_responsive .actions .button:hover,
	...
	{$rule}.woocommerce-MyAccount-navigation > ul > li a:hover {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_link']) . "
	}
	
	{$rule}#page .cmsmasters_dynamic_cart .remove,
	{$rule}#page .widget_shopping_cart .cart_list .remove {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['healthy-living' . '_' . $scheme . '_link']) . ", .7);
	}
	...
	{$rule}.select2-container.select2-container--focus .select2-selection--single {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_link']) . "
	}
	
	{$rule}.select2-container.select2-container--open .select2-selection--single,
	{$rule}.select2-container.select2-container--focus .select2-selection--single {
		-webkit-box-shadow:inset 0 0 0 1px rgba(" . cmsmasters_color2rgb($cmsmasters_option['healthy-living' . '_' . $scheme . '_link']) . ", 1);
		box-shadow:inset 0 0 0 1px rgba(" . cmsmasters_color2rgb($cmsmasters_option['healthy-living' . '_' . $scheme . '_link']) . ", 1);
	}
	/* Finish Primary Color */
	...
	{$rule}.cmsmasters_product .cmsmasters_product_add_inner .button {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_hover']) . "
	}
	
	{$rule}.link_hover_color {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_hover']) . "
	}
	/* Finish Highlight Color */
	...
	{$rule}.cmsmasters_dynamic_cart .buttons a,
	{$rule}.cmsmasters_dynamic_cart .buttons a:hover,
	{$rule}.widget_price_filter .ui-slider-handle, 
	{$rule}.woocommerce-store-notice,
	{$rule}#page ~ .datepicker .active {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_heading']) . "
	}
	
	{$rule}.cmsmasters_dynamic_cart .widget_shopping_cart_content:after {
		" . cmsmasters_color_css('border-bottom-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_heading']) . "
	}
	/* Finish Headings Color */
	...
	{$rule}.woocommerce-store-notice .woocommerce-store-notice__dismiss-link {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_bg']) . "
	}
	
	{$rule}.cmsmasters_dynamic_cart .buttons a {
		border-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['healthy-living' . '_' . $scheme . '_hover']) . ", .15);
	}
	/* Finish Main Background Color */
	...
	{$rule}.shop_table.order_details tfoot tr:last-child th,
	{$rule}.shop_table.order_details tfoot tr:last-child td {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_alternate']) . "
	}
	
	{$rule}.woocommerce-checkout-payment .payment_methods .payment_box:after {
		" . cmsmasters_color_css('border-bottom-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_alternate']) . "
	}
	/* Finish Alternate Background Color */
	...
	{$rule}.widget_price_filter .price_slider {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_border']) . "
	}
	...
	{$rule}.select2-container .select2-selection--single {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_border']) . "
	}
	
	{$rule}.woocommerce-checkout-payment .payment_methods .payment_box:before {
		" . cmsmasters_color_css('border-bottom-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_border']) . "
	}
	/* Finish Borders Color */
...
/***************** Start {$title} Events Color Scheme Rules ******************/
	...
	{$rule}#tribe-bar-views.tribe-bar-views-open .tribe-bar-views-toggle,
	...
	{$rule}#tribe-bar-views.tribe-bar-views-open .tribe-bar-views-toggle > span,
	{$rule}#tribe-bar-views.tribe-bar-views-open .tribe-bar-views-toggle > span:before,
	{$rule}#tribe-bar-views.tribe-bar-views-open .tribe-bar-views-toggle > span:after,
	...
	{$rule}.tribe-events-photo .cmsmasters_event_date_details {
		color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['healthy-living' . '_' . $scheme . '_hover']) . ", .7);
	}
	...
	{$rule}#tribe-bar-views .tribe-bar-views-toggle > span,
	{$rule}#tribe-bar-views .tribe-bar-views-toggle > span:before,
	{$rule}#tribe-bar-views .tribe-bar-views-toggle > span:after,
	...
	{$rule}#tribe-bar-views .tribe-bar-views-toggle:hover > span,
	{$rule}#tribe-bar-views .tribe-bar-views-toggle:hover > span:before,
	{$rule}#tribe-bar-views .tribe-bar-views-toggle:hover > span:after {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_bg']) . "
	}
	
	{$rule}table.tribe-events-calendar thead th {
		border-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['healthy-living' . '_' . $scheme . '_bg']) . ", .1);
	}
	
	{$rule}.tribe-events-tooltip:after {
		" . cmsmasters_color_css('border-top-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_bg']) . "
	}
	
	{$rule}.tribe-events-grid .tribe-events-tooltip:after {
		" . cmsmasters_color_css('border-right-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_bg']) . "
	}
	...
	{$rule}.tribe-events-grid .tribe-events-day-column-6 .tribe-events-tooltip:after {
		" . cmsmasters_color_css('border-left-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_bg']) . "
	}
	/* Finish Main Background Color */
	...
	{$rule}.tribe-events-tooltip:before {
		" . cmsmasters_color_css('border-top-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_border']) . "
	}
	
	{$rule}.tribe-events-grid .tribe-events-tooltip:before {
		" . cmsmasters_color_css('border-right-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_border']) . "
	}
	...
	{$rule}.tribe-events-grid .tribe-events-day-column-6 .tribe-events-tooltip:before {
		" . cmsmasters_color_css('border-left-color', $cmsmasters_option['healthy-living' . '_' . $scheme . '_border']) . "
	}
	/* Finish Borders Color */
...
/***************** Start Header Middle Color Scheme Rules ******************/
	...
	.header_mid select,
	.header_mid option {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_mid_color']) . "
	}
	...
	.header_mid .search_wrap .search_bar_wrap .search_button button {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_mid_link']) . "
	}
	
	#page .header_mid .cmsmasters_social_icon:hover,
	.header_mid .search_wrap .search_bar_wrap .search_button button:hover {
		color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['healthy-living' . '_header_mid_link']) . ", 0.5);
	}
	...
	.header_mid .resp_mid_nav_wrap .resp_mid_nav.active > span:after {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_header_mid_link']) . "
	}
	...
	.header_mid a:hover {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_mid_hover']) . "
	}
	...
	.header_mid button {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_header_mid_hover']) . "
	}
	
	.header_mid input:not([type=submit]):not([type=button]):not([type=radio]):not([type=checkbox]):focus,
	.header_mid textarea:focus,
	.header_mid select:focus {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['healthy-living' . '_header_mid_hover']) . "
	}
	...
	.header_mid input[type=button]:hover, 
	.header_mid button:hover {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_mid_bg']) . "
	}
	...
	.header_mid select,
	.header_mid option {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_header_mid_bg']) . "
	}
	...
	.header_mid.header_mid_scroll {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_header_mid_bg_scroll']) . "
	}
	...
	.header_mid .header_mid_outer {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['healthy-living' . '_header_mid_border']) . "
	}
	...
	.header_mid ::selection {
		" . cmsmasters_color_css('background', $cmsmasters_option['healthy-living' . '_header_mid_link']) . "
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_mid_bg_scroll']) . "
	}
...
/***************** Start Header Bottom Color Scheme Rules ******************/
	...
	.header_bot select,
	.header_bot option {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_bot_color']) . "
	}
	...
	.header_bot a {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_bot_link']) . "
	}
	...
	.header_bot .resp_bot_nav_wrap .resp_bot_nav.active > span:after {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_header_bot_link']) . "
	}
	...
	.header_bot a:hover {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_bot_hover']) . "
	}
	...
	.header_bot .search_wrap .search_bar_wrap .search_button button {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_header_bot_hover']) . "
	}
	
	.header_bot input:not([type=submit]):not([type=button]):not([type=radio]):not([type=checkbox]):focus,
	.header_bot textarea:focus,
	.header_bot select:focus {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['healthy-living' . '_header_bot_hover']) . "
	}
	...
	.header_bot button, 
	.header_bot .search_wrap .search_bar_wrap .search_button button {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_bot_bg']) . "
	}
	...
	.header_bot select,
	.header_bot option {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_header_bot_bg']) . "
	}
	...
	.header_bot.header_bot_scroll {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_header_bot_bg_scroll']) . "
	}
	...
	.header_bot .header_bot_outer {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['healthy-living' . '_header_bot_border']) . "
	}
	...
	.header_bot ::selection {
		" . cmsmasters_color_css('background', $cmsmasters_option['healthy-living' . '_header_bot_link']) . "
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_bot_bg']) . "
	}
...
/***************** Start Navigation Color Scheme Rules ******************/
	...
	@media only screen and (min-width: 1025px) {
		ul.navigation > li > a {
			" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_navigation_title_link']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		...
		ul.navigation > li:hover > a {
			" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_navigation_title_link_hover']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		...
		ul.navigation > li > a .nav_tag {
			" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_navigation_title_link_current']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		...
		ul.navigation > li:hover > a .nav_subtitle {
			" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_navigation_title_link_subtitle']) . "
		}
		
		ul.navigation > li > a .nav_tag {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_navigation_title_link_subtitle']) . "
		}
		
		ul.navigation > li > a .nav_tag:before {
			" . cmsmasters_color_css('border-color', $cmsmasters_option['healthy-living' . '_navigation_title_link_subtitle']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		ul.navigation > li > a {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_navigation_title_link_bg']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		ul.navigation > li > a:hover,
		ul.navigation > li:hover > a {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_navigation_title_link_bg_hover']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		...
		ul.navigation > li.menu-item.current-menu-ancestor > a,
		ul.navigation > li.menu-item.current_page_item > a {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_navigation_title_link_bg_current']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		...
		ul.navigation > li.menu-item.current_page_item > a {
			" . cmsmasters_color_css('border-color', $cmsmasters_option['healthy-living' . '_navigation_title_link_border']) . "
		}
	}
	...
	.navigation li .menu-item-mega-description-container * {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_navigation_dropdown_text']) . "
	}
	...
	@media only screen and (max-width: 1024px) {
		ul.navigation {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_navigation_dropdown_bg']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		ul.navigation ul, 
		ul.navigation .menu-item-mega-container {
			" . cmsmasters_color_css('border-color', $cmsmasters_option['healthy-living' . '_navigation_dropdown_border']) . "
		}
	}
	...
	.navigation li a {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_navigation_dropdown_link']) . "
	}
	...
	.navigation li a .nav_tag {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_navigation_dropdown_link_hover']) . "
	}
	...
	@media only screen and (max-width: 768px) {
		.header_mid .header_mid_inner .search_wrap {
			background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['healthy-living' . '_navigation_dropdown_link_hover']) . ", .05);
		}
	}
	...
	.navigation li a .nav_subtitle {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_navigation_dropdown_link_subtitle']) . "
	}
	
	.navigation li a .nav_tag {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_navigation_dropdown_link_subtitle']) . "
	}
	...
	.navigation li:hover > a .nav_title:after {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_navigation_dropdown_link_highlight']) . "
	}
	...
	.navigation li {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['healthy-living' . '_navigation_dropdown_link_border']) . "
	}
...
/***************** Start Header Top Color Scheme Rules ******************/
	...
	.header_top {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_top_color']) . "
	}
	...
	.header_top a,
	#page .header_top .cmsmasters_social_icon {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_top_link']) . "
	}
	...
	#page .header_top .cmsmasters_social_icon:hover {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_top_hover']) . "
	}
	...
	.header_top {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_header_top_bg']) . "
	}
	...
	.header_top .header_top_outer {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['healthy-living' . '_header_top_border']) . "
	}
	...
	.header_top ::selection {
		" . cmsmasters_color_css('background', $cmsmasters_option['healthy-living' . '_header_top_link']) . "
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_top_bg']) . "
	}
...
/***************** Start Header Top Navigation Color Scheme Rules ******************/
	...
	@media only screen and (min-width: 1025px) {
		ul.top_line_nav > li > a {
			" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_top_title_link']) . "
		}
	}
	...
	.header_top .responsive_top_nav > span:after {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_header_top_title_link']) . "
	}
	...
	@media only screen and (min-width: 1025px) {
		...
		ul.top_line_nav > li.current-menu-ancestor > a {
			" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_top_title_link_hover']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		ul.top_line_nav > li > a {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_header_top_title_link_bg']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		...
		ul.top_line_nav > li.current-menu-item > a,
		ul.top_line_nav > li.current-menu-ancestor > a {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_header_top_title_link_bg_hover']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		ul.top_line_nav > li {
			" . cmsmasters_color_css('border-color', $cmsmasters_option['healthy-living' . '_header_top_title_link_border']) . "
		}
	}
	...
	@media only screen and (max-width: 1024px) {
		ul.top_line_nav {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_header_top_dropdown_bg']) . "
		}
	}
	...
	@media only screen and (min-width: 1025px) {
		ul.top_line_nav ul {
			" . cmsmasters_color_css('border-color', $cmsmasters_option['healthy-living' . '_header_top_dropdown_border']) . "
		}
	}
	...
	.top_line_nav li a {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_top_dropdown_link']) . "
	}
	...
	.top_line_nav li.current-menu-item > a {
		" . cmsmasters_color_css('color', $cmsmasters_option['healthy-living' . '_header_top_dropdown_link_hover']) . "
	}
	...
	.top_line_nav li > a:hover,
	.top_line_nav li.current-menu-item > a {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['healthy-living' . '_header_top_dropdown_link_highlight']) . "
	}
	...
	.top_line_nav li {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['healthy-living' . '_header_top_dropdown_link_border']) . "
	}
...
";
	...
	return apply_filters('healthy_living_theme_colors_secondary_filter', $custom_css);
}
