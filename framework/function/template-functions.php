...
function healthy_living_get_page_classes($cmsmasters_option, $classes = false) {
	$browser = new Browser();
	if (
	...
	echo 'cmsmasters_' . $cmsmasters_option['healthy-living' . '_theme_layout'] . ' ';

	if ($cmsmasters_option['healthy-living' . '_fixed_header']) {
		echo 'fixed_header ';
	}

	if ($cmsmasters_option['healthy-living' . '_header_top_line']) {
		echo 'enable_header_top ';
	}

	if ($cmsmasters_option['healthy-living' . '_header_styles'] != 'default') {
		echo 'enable_header_bottom ';
	}

	if ($cmsmasters_option['healthy-living' . '_header_styles'] == 'r_nav') {
		echo 'enable_header_right ';
	}

	if ($cmsmasters_option['healthy-living' . '_header_styles'] == 'c_nav') {
	...
	if ($cmsmasters_header_overlaps == '') {
		$cmsmasters_header_overlaps = $cmsmasters_option['healthy-living' . '_header_overlaps'];
	}
...
function healthy_living_header_top($cmsmasters_option) {
	if ($cmsmasters_option['healthy-living' . '_header_top_line']) {
		echo '<div class="header_top" data-height="' . esc_attr($cmsmasters_option['healthy-living' . '_header_top_height']) . '">' . 
			'<div class="header_top_outer">' . 
				'<div class="header_top_inner">';
					
					if (
						$cmsmasters_option['healthy-living' . '_header_top_line_add_cont'] !== 'none' || 
						(
							CMSMASTERS_DONATIONS && 
							isset($cmsmasters_option['healthy-living' . '_header_top_line_donations_but']) && 
							$cmsmasters_option['healthy-living' . '_header_top_line_donations_but'] &&
							isset($cmsmasters_option['healthy-living' . '_header_top_line_donations_but_text']) && 
							$cmsmasters_option['healthy-living' . '_header_top_line_donations_but_text'] != '' 
						)
					) {
						...
						if (
							$cmsmasters_option['healthy-living' . '_header_top_line_add_cont'] == 'social' && 
							isset($cmsmasters_option['healthy-living' . '_social_icons'])
						) {
							healthy_living_social_icons();
						} elseif (
							$cmsmasters_option['healthy-living' . '_header_top_line_add_cont'] == 'nav' && 
						...
						if (
							...
							echo '<a href="' . esc_url(get_permalink($cmsmasters_donations_form_page)) . '" class="header_top_donation_but"><span>' . esc_html($cmsmasters_option['healthy-living' . '_header_top_line_donations_but_text']) . '</span></a>';
						}
					...
					if ($cmsmasters_option['healthy-living' . '_header_top_line_short_info'] !== '') {
						echo '<div class="header_top_left">' . 
							'<div class="meta_wrap">' . 
								stripslashes($cmsmasters_option['healthy-living' . '_header_top_line_short_info']) . 
							'</div>' . 
						'</div>';
					} 
...
function healthy_living_header_mid($cmsmasters_option) {
	echo '<div class="header_mid" data-height="' . esc_attr($cmsmasters_option['healthy-living' . '_header_mid_height']) . '">' . 
		'<div class="header_mid_outer">' . 
			'<div class="header_mid_inner">' . 
				...
				if (
					CMSMASTERS_DONATIONS && 
					isset($cmsmasters_option['healthy-living' . '_header_donations_but']) && 
					$cmsmasters_option['healthy-living' . '_header_donations_but'] && 
					isset($cmsmasters_option['healthy-living' . '_header_donations_but_text']) && 
					$cmsmasters_option['healthy-living' . '_header_donations_but_text'] != '' && 
					$cmsmasters_option['healthy-living' . '_header_styles'] != 'default' && 
					$cmsmasters_option['healthy-living' . '_header_styles'] != 'c_nav'
				) {
					$cmsmasters_donations_form_page = get_option('cmsmasters_donations_form_page');
						...
						'<div class="header_donation_but_wrap_inner">' . 
							'<div class="header_donation_but">' . 
								'<a href="' . esc_url(get_permalink($cmsmasters_donations_form_page)) . '" class="cmsmasters_button">' . 
									'<span>' . esc_html($cmsmasters_option['healthy-living' . '_header_donations_but_text']) . '</span>' . 
								'</a>' . 
							'</div>' . 
						'</div>' . 
					'</div>';
				...
				if ($cmsmasters_option['healthy-living' . '_header_styles'] == 'c_nav') { 
					echo '<div class="slogan_social_wrap">';
						...
						if (
							$cmsmasters_option['healthy-living' . '_header_add_cont'] == 'cust_html' && 
							$cmsmasters_option['healthy-living' . '_header_add_cont_cust_html'] !== ''
						) {
							echo '<div class="slogan_wrap">' . 
								'<div class="slogan_wrap_inner">' . 
									'<div class="slogan_wrap_text">' . 
										stripslashes($cmsmasters_option['healthy-living' . '_header_add_cont_cust_html']) . 
									'</div>' . 
								'</div>' . 
							'</div>';
						} elseif (
							$cmsmasters_option['healthy-living' . '_header_add_cont'] == 'social' && 
							isset($cmsmasters_option['healthy-living' . '_social_icons'])
						) {
							healthy_living_social_icons();
						}
				...
				if ($cmsmasters_option['healthy-living' . '_header_styles'] == 'c_nav') {
					...
					if (CMSMASTERS_WOOCOMMERCE) {
						healthy_living_woocommerce_cart_dropdown($cmsmasters_option);
					}
					
					
					if ($cmsmasters_option['healthy-living' . '_header_search']) {
						echo '<div class="search_wrap no_dn">' . 
				...
				if (
					$cmsmasters_option['healthy-living' . '_header_styles'] != 'c_nav' &&
					$cmsmasters_option['healthy-living' . '_header_search']
				) {
					echo '<div class="search_wrap dn">' . 
						'<div class="search_wrap_inner">';
...
function healthy_living_header_bot($cmsmasters_option) {
	if ($cmsmasters_option['healthy-living' . '_header_styles'] != 'default') {
		echo '<div class="header_bot" data-height="' . esc_attr($cmsmasters_option['healthy-living' . '_header_bot_height']) . '">' . 
			'<div class="header_bot_outer">' . 
				'<div class="header_bot_inner">' . 
					'<div class="resp_bot_nav_wrap">' . 
						'<div class="resp_bot_nav_outer">' . 
							'<a class="responsive_nav resp_bot_nav" href="javascript:void(0);">' . 
								'<span></span>' . 
							'</a>' . 
						'</div>' . 
					'</div>' . 
...
/* Get Logo Function */
function healthy_living_logo() {
	$cmsmasters_option = healthy_living_get_global_options();
	
	
	if ($cmsmasters_option['healthy-living' . '_logo_type'] == 'text') {
		if ($cmsmasters_option['healthy-living' . '_logo_title'] != '') {
			$blog_title = stripslashes($cmsmasters_option['healthy-living' . '_logo_title']);
		} else {
			$blog_title = (get_bloginfo('name')) ? get_bloginfo('name') : 'Healthy Living';
		}
		
		
		if ($cmsmasters_option['healthy-living' . '_logo_subtitle'] != '') {
			$blog_descr = stripslashes($cmsmasters_option['healthy-living' . '_logo_subtitle']);
		} else {
			$blog_descr = (get_bloginfo('description')) ? get_bloginfo('description') : esc_html__('Default Logo Subtitle', 'healthy-living');
		}
		...
		echo '<a href="' . esc_url(home_url('/')) . '" title="' . esc_attr($blog_title) . '" class="logo">' . "\n\t" . 
			'<span class="logo_text_wrap">' . 
				...
				($cmsmasters_option['healthy-living' . '_logo_subtitle'] ? '<span class="title_text">' . esc_html($blog_descr) . '</span>' : '') . 
			'</span>' . 
		'</a>';
	} else {
		...
		if ($cmsmasters_option['healthy-living' . '_logo_url'] == '') {
			...
			$logo_img = explode('|', $cmsmasters_option['healthy-living' . '_logo_url']);
			...
			if ($cmsmasters_option['healthy-living' . '_logo_url_retina'] != '') {
				$logo_img_retina = explode('|', $cmsmasters_option['healthy-living' . '_logo_url_retina']);
...
/* Logo Styles */
function healthy_living_theme_logo_styles() {
	$cmsmasters_option = healthy_living_get_global_options();
	...
	if (
		$cmsmasters_option['healthy-living' . '_logo_type'] == 'text' && 
		$cmsmasters_option['healthy-living' . '_logo_custom_color']
	) {
		$out .= "
...
";
		...
		$header_mid_height = (($cmsmasters_option['healthy-living' . '_header_mid_height'] !== '') ? $cmsmasters_option['healthy-living' . '_header_mid_height'] : '95');
...
function healthy_living_footer_logo($cmsmasters_option) {
	if (
		$cmsmasters_option['healthy-living' . '_footer_type'] == 'default' && 
		$cmsmasters_option['healthy-living' . '_footer_logo']
	) {
		...
		if ($cmsmasters_option['healthy-living' . '_footer_logo_url'] == '') {
			...
			$footer_logo_img = explode('|', $cmsmasters_option['healthy-living' . '_footer_logo_url']);
			...
			if ($cmsmasters_option['healthy-living' . '_footer_logo_url_retina'] != '') {
				$footer_logo_img_retina = explode('|', $cmsmasters_option['healthy-living' . '_footer_logo_url_retina']);
...
function healthy_living_get_footer_custom_html($cmsmasters_option) {
	if (
		(
			$cmsmasters_option['healthy-living' . '_footer_type'] == 'default' && 
			$cmsmasters_option['healthy-living' . '_footer_html'] !== ''
		) || (
			$cmsmasters_option['healthy-living' . '_footer_type'] == 'small' && 
			$cmsmasters_option['healthy-living' . '_footer_additional_content'] == 'text' && 
			$cmsmasters_option['healthy-living' . '_footer_html'] !== ''
		)
	) {
		echo '<div class="footer_custom_html_wrap">' . 
			'<div class="footer_custom_html">' . 
				do_shortcode(stripslashes($cmsmasters_option['healthy-living' . '_footer_html'])) . 
			'</div>' . 
		'</div>';
	}
}
...
function healthy_living_get_footer_nav($cmsmasters_option) {
	if (
		has_nav_menu('footer') && 
		(
			(
				$cmsmasters_option['healthy-living' . '_footer_type'] == 'default' && 
				$cmsmasters_option['healthy-living' . '_footer_nav']
			) || (
				$cmsmasters_option['healthy-living' . '_footer_type'] == 'small' && 
				$cmsmasters_option['healthy-living' . '_footer_additional_content'] == 'nav'
			)
		)
	) {
...
function healthy_living_get_footer_social_icons($cmsmasters_option) {
	if (
		isset($cmsmasters_option['healthy-living' . '_social_icons']) && 
		(
			(
				$cmsmasters_option['healthy-living' . '_footer_type'] == 'default' && 
				$cmsmasters_option['healthy-living' . '_footer_social']
			) || (
				$cmsmasters_option['healthy-living' . '_footer_type'] == 'small' && 
				$cmsmasters_option['healthy-living' . '_footer_additional_content'] == 'social'
			)
		)
	) {
		healthy_living_social_icons();
...
function healthy_living_page_heading() {
	$cmsmasters_option = healthy_living_get_global_options();
	...
	if (
		...
		$cmsmasters_header_overlaps = $cmsmasters_option['healthy-living' . '_header_overlaps'] ? 'true' : 'false';
		
		$cmsmasters_heading_alignment = $cmsmasters_option['healthy-living' . '_heading_alignment'];
		$cmsmasters_heading_scheme = $cmsmasters_option['healthy-living' . '_heading_scheme'];
		
		$cmsmasters_breadcrumbs = $cmsmasters_option['healthy-living' . '_breadcrumbs'] ? 'true' : 'false';
	}
					...
					if ($cmsmasters_heading == 'custom') {
						...
						if (is_search()) {
							...
							if (!empty($wp_query->found_posts)) {
								echo sprintf(esc_html(_n('1 search result for: %2$s', '%1$d search results for: %2$s', $wp_query->found_posts, 'healthy-living')), $wp_query->found_posts, get_search_query());
							} else {
								echo sprintf(esc_html__('0 search results for: %s', 'healthy-living'), get_search_query());
							}
						} elseif (is_archive()) {
							if (is_author()) {
								if (get_the_author_meta('first_name') != '' || get_the_author_meta('last_name') != '') {
									echo sprintf(esc_html__('Author: %1$s (%2$s %3$s)', 'healthy-living'), '<span class="vcard">' . get_the_author() . '</span>', get_the_author_meta('first_name'), get_the_author_meta('last_name'));
								} else {
									echo sprintf(esc_html__('Author: %s', 'healthy-living'), '<span class="vcard">' . get_the_author() . '</span>');
								}
							} else if (
								CMSMASTERS_EVENTS_CALENDAR && 
								(
...
/* Get Page Heading Function */
function healthy_living_theme_page_heading_styles() {
	$cmsmasters_option = healthy_living_get_global_options();
	...
	if (
		...
		$cmsmasters_heading_height = $cmsmasters_option['healthy-living' . '_heading_height'];
		$cmsmasters_heading_bg_color = $cmsmasters_option['healthy-living' . '_heading_bg_color'];
		$cmsmasters_heading_bg_img_enable = $cmsmasters_option['healthy-living' . '_heading_bg_image_enable'] ? 'true' : 'false';
		$cmsmasters_heading_bg_img = $cmsmasters_option['healthy-living' . '_heading_bg_image'];
		$cmsmasters_heading_bg_rep = $cmsmasters_option['healthy-living' . '_heading_bg_repeat'];
		$cmsmasters_heading_bg_att = $cmsmasters_option['healthy-living' . '_heading_bg_attachment'];
		$cmsmasters_heading_bg_size = $cmsmasters_option['healthy-living' . '_heading_bg_size'];
	}
...
function healthy_living_social_icons() {
	$cmsmasters_option = healthy_living_get_global_options();
...
<div class=\"social_wrap\">
	...
	foreach ($cmsmasters_option['healthy-living' . '_social_icons'] as $cmsmasters_social_icons) {
...
function healthy_living_theme_social_icons_styles() {
	$cmsmasters_option = healthy_living_get_global_options();
	$out = '';
	$i = 1;

	if (isset($cmsmasters_option['healthy-living' . '_social_icons']) && is_array($cmsmasters_option['healthy-living' . '_social_icons'])) {
		foreach ($cmsmasters_option['healthy-living' . '_social_icons'] as $cmsmasters_social_icons) {
...
function healthy_living_thumb($cmsmasters_id, $type = 'post-thumbnail', $link = true, $group = false, $preload = true, $highImg = false, $fullwidth = true, $show = true, $attachment = false, $unique = false, $link_icon = false, $placeholder_icon = 'cmsmasters_theme_icon_image') {
	$args = array( 
...
function healthy_living_thumb_rollover($cmsmasters_id, $type = 'post-thumbnail', $rollover = true, $open_link = true, $group = false, $attachment_images = false, $attachment_video_type = false, $attachment_video_link = false, $attachment_video_links = false, $highImg = false, $show = true, $link_redirect = false, $link_url = false, $link_target = false, $placeholder_icon = 'cmsmasters_theme_icon_image') {
	...
	if ($rollover) {
		...
		$out .= '<div class="cmsmasters_img_rollover">' . 
			'<a href="' . (($link_redirect == 'true' && $link_url != '') ? esc_url($link_url) : esc_url(get_permalink($cmsmasters_id))) . '"' . (($link_redirect == 'true' && $link_target == 'true') ? ' target="_blank"' : '') . ' title="' . esc_attr($cmsmasters_title) . '" class="cmsmasters_open_post_link button">' . esc_html__('Read more', 'healthy-living') . '</a>' . 
		'</div>';
	} else {
		$out .= '<div class="cmsmasters_img_rollover">' . 
...
function healthy_living_thumb_small($cmsmasters_id, $type = 'post', $w = 100, $h = 100, $show = true) {
...
/* Get Heading Function */
function healthy_living_get_comments($class = false, $show = false) { 
	$out = '';
	
	
	if (comments_open()) {
		$out .= '<span class="cmsmasters_comments' . ($class ? ' ' . $class : '') . '">' . 
			'<a class="cmsmasters_theme_icon_comment" href="' . esc_url(get_comments_link()) . '" title="' . esc_attr__('Comment on', 'healthy-living') . ' ' . esc_attr(get_the_title()) . '">' . 
...
function healthy_living_prev_next_posts() {
	...
	if ($published_posts > 1) {
		echo '<aside class="post_nav">';
			...
			previous_post_link('<span class="cmsmasters_prev_post">%link<span class="cmsmasters_prev_arrow"><span></span></span><span class="sub">' . esc_html__('previous', 'healthy-living' ) . '</span></span>');
			
			next_post_link('<span class="cmsmasters_next_post">%link<span class="cmsmasters_next_arrow"><span></span></span><span class="sub">' . esc_html__('next', 'healthy-living' ) . '</span></span>');
...
function healthy_living_sharing_box($title_box = false, $tag = 'h3') {
	...
	echo "<aside class=\"share_posts\">
		...
		<div class=\"share_posts_inner\">
			<a href=\"https://www.facebook.com/sharer/sharer.php?display=popup&u={$page_link}\">" . esc_html__('Facebook', 'healthy-living') . "</a>
			<a href=\"https://twitter.com/intent/tweet?text=" . urlencode(html_entity_decode(sprintf(esc_attr__("Check out '%s' on %s website", 'healthy-living'), $social_title, $website_name), ENT_QUOTES, 'UTF-8')) . "&url={$page_link}\">" . esc_html__('Twitter', 'healthy-living') . "</a>
			<a href=\"" . esc_url("https://pinterest.com/pin/create/button/?url={$page_link}&media={$pinterest_img}&description={$social_title}") . "\">" . esc_html__('Pinterest', 'healthy-living') . "</a>
		</div>
	</aside>
";
}
...
function healthy_living_author_box($title_box = false, $tag = 'h3', $author_tag = 'h4') {
	...
	if ($user_description) {
		...
		if ($user_url) {
			echo '<a href="' . esc_url($user_url) . '" title="' . esc_attr(get_the_author()) . ' ' . esc_attr__('website', 'healthy-living') . '" target="_blank">' . esc_html($user_url) . '</a>';
		}
...
function healthy_living_related($tag = 'h3', $box_type = false, $tgsarray = null, $items_number = 5, $pause_time = 5, $type = 'post', $taxonomy = null) {
	if ( 
		...
		echo "<aside class=\"cmsmasters_single_slider" . (($type == 'campaign') ? ' cmsmasters_single_slider_campaign' : '') . "\">
			...
			if ($type == 'post') {
				esc_html_e('More posts', 'healthy-living');
			} elseif ($type == 'campaign') {
				esc_html_e('More campaigns', 'healthy-living');
			} else {
				esc_html_e('More projects', 'healthy-living');
			}
			...
			if ($r_query->have_posts()) {
						...
						while ($r_query->have_posts()) : $r_query->the_post();
							echo "<div class=\"cmsmasters_single_slider_item\">
								<div class=\"cmsmasters_single_slider_item_outer\">";
									...
									healthy_living_thumb(get_the_ID(), 'cmsmasters-project-thumb', true, false, true, false, true, true, false, false, false, 'cmsmasters_theme_icon_image');
									
									echo "<div class=\"cmsmasters_single_slider_item_inner_wrap\">
				...
				if ($type == 'post') {
					esc_html_e('No posts found', 'healthy-living');
				} elseif ($type == 'campaign') {
					esc_html_e('No campaigns found', 'healthy-living');
				} else {
					esc_html_e('No projects found', 'healthy-living');
				}
...
function healthy_living_author_avatar($template_type = 'page') {
...
/* Get Category List */
function healthy_living_get_the_category_list($cmsmasters_id, $taxonomy, $sep = '', $before = '', $after = '') {
...
if (!function_exists('healthy_living_get_post_pings')) {

function healthy_living_get_post_pings($id, $tag = 'h3') {
	$out = '';
	...
	if (pings_open($id) && sizeof($pings) > 0) {
		$out .= '<aside class="cmsmasters_pings_list">' . "\n" .
			'<' . esc_html($tag) . '>' . esc_html__('Trackbacks and Pingbacks', 'healthy-living') . '</' . esc_html($tag) . '>' . "\n" .
