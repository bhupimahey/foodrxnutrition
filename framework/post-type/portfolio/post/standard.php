...
if (
	$cmsmasters_option['healthy-living' . '_portfolio_project_like'] || 
	$cmsmasters_option['healthy-living' . '_portfolio_project_date'] || 
	$cmsmasters_option['healthy-living' . '_portfolio_project_cat'] || 
	$cmsmasters_option['healthy-living' . '_portfolio_project_comment'] || 
	$cmsmasters_option['healthy-living' . '_portfolio_project_author'] || 
	$cmsmasters_option['healthy-living' . '_portfolio_project_tag'] || 
	(
	...
	if (
		...
		if ($cmsmasters_project_title == 'true') {
			echo '<header class="cmsmasters_project_header entry-header">';
				healthy_living_project_title_nolink(get_the_ID(), 'h2');
			echo '</header>';
		}
	}
	...
	echo '<div class="project_content' . (($project_sidebar == 'true') ? ' with_sidebar' : '');
		...
		?>
			...
			<?php 
				...
				healthy_living_thumb(get_the_ID(), 'cmsmasters-full-masonry-thumb', false, 'img_' . get_the_ID(), true, true, false, true, $cmsmasters_project_images[0]);
			} elseif (has_post_thumbnail()) {
				healthy_living_thumb(get_the_ID(), 'cmsmasters-full-masonry-thumb', false, 'img_' . get_the_ID(), true, true, false, true, false);
			}
		}
				...
				echo '<div class="project_sidebar">';
					...
					if ($project_details == 'true') {
						echo '<div class="project_details entry-meta">';
							...
							healthy_living_get_project_likes('post');
							
							healthy_living_get_project_comments('post');
							
							healthy_living_get_project_author('post');
							
							healthy_living_get_project_date('post');
							
							healthy_living_get_project_category(get_the_ID(), 'pj-categs', 'post');
							
							healthy_living_get_project_tags(get_the_ID(), 'pj-tags');
							
							healthy_living_get_project_features('details', $cmsmasters_project_features, false, 'h4', true);
							
							healthy_living_project_link($cmsmasters_project_link_text, $cmsmasters_project_link_url, $cmsmasters_project_link_target);
							
						echo '</div>';
					}
					
					
					healthy_living_get_project_features('features', $cmsmasters_project_features_one, $cmsmasters_project_features_one_title, 'h4', true);
					
					healthy_living_get_project_features('features', $cmsmasters_project_features_two, $cmsmasters_project_features_two_title, 'h4', true);
					
					healthy_living_get_project_features('features', $cmsmasters_project_features_three, $cmsmasters_project_features_three_title, 'h4', true);
