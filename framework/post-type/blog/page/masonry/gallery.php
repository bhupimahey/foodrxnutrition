		...
		<?php 
			...
			<?php 
				...
				echo '<div class="cmsmasters_date_img_wrap">';
					...
					healthy_living_thumb(get_the_ID(), 'cmsmasters-blog-masonry-thumb', false, 'img_' . get_the_ID(), true, true, true, true, $cmsmasters_post_images[0]);
					
				echo '</div>';
			} elseif (!post_password_required() && has_post_thumbnail()) {
				echo '<div class="cmsmasters_date_img_wrap">';
					
					healthy_living_thumb(get_the_ID(), 'cmsmasters-blog-masonry-thumb', false, 'img_' . get_the_ID(), true, true, true, true, false);
			...
			<?php 
				if ($date) {
					echo '<div class="cmsmasters_post_info entry-meta">';
						...
						$date ? healthy_living_get_post_date('page', 'masonry') : '';
				...
				healthy_living_post_exc_cont('page', 'masonry');
