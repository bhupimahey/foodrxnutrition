		...
		<?php 
			if (!post_password_required() && $cmsmasters_post_image_link != '') {
				echo '<div class="cmsmasters_date_img_wrap">';
					...
					healthy_living_thumb(get_the_ID(), 'cmsmasters-masonry-thumb', false, 'img_' . get_the_ID(), true, true, true, true, $cmsmasters_post_image_link);
					
				echo '</div>';
			} elseif (!post_password_required() && has_post_thumbnail()) {
				echo '<div class="cmsmasters_date_img_wrap">';
				
					healthy_living_thumb(get_the_ID(), 'cmsmasters-masonry-thumb', false, 'img_' . get_the_ID(), true, true, true, true, false);
