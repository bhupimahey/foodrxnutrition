...
(function ($) { 
	...
	if ($('input[name*="' + cmsmasters_settings.shortname + '_footer_type"]:checked').val() !== 'small') {
		...
		$('#' + cmsmasters_settings.shortname + '_footer_bg_image_enable').parents('tr').show();
		...
		$('#' + cmsmasters_settings.shortname + '_footer_bg_image_enable').parents('tr').hide();
		$('#' + cmsmasters_settings.shortname + '_footer_bg_image').parents('tr').hide();
		$('label[for="' + cmsmasters_settings.shortname + '_footer_bg_repeat"]').parents('tr').hide();
		$('label[for="' + cmsmasters_settings.shortname + '_footer_bg_pos"]').parents('tr').hide();
		$('label[for="' + cmsmasters_settings.shortname + '_footer_bg_attachment"]').parents('tr').hide();
		$('label[for="' + cmsmasters_settings.shortname + '_footer_bg_size"]').parents('tr').hide();
	...
	$('input[name*="' + cmsmasters_settings.shortname + '_footer_type"]').on('change', function () { 
		if ($('input[name*="' + cmsmasters_settings.shortname + '_footer_type"]:checked').val() === 'small') {
			...
			$('#' + cmsmasters_settings.shortname + '_footer_bg_image_enable').parents('tr').show();
			$('#' + cmsmasters_settings.shortname + '_footer_bg_image').parents('tr').show();
			$('label[for="' + cmsmasters_settings.shortname + '_footer_bg_repeat"]').parents('tr').show();
			$('label[for="' + cmsmasters_settings.shortname + '_footer_bg_pos"]').parents('tr').show();
			$('label[for="' + cmsmasters_settings.shortname + '_footer_bg_attachment"]').parents('tr').show();
			$('label[for="' + cmsmasters_settings.shortname + '_footer_bg_size"]').parents('tr').show();
		}
	} );
	...
	/* General 'Footer' Tab Fields Load */
	if ($('#' + cmsmasters_settings.shortname + '_footer_bg_image_enable').is(':not(:checked)')) {
		$('#' + cmsmasters_settings.shortname + '_footer_bg_image').parents('tr').hide();
		$('label[for="' + cmsmasters_settings.shortname + '_footer_bg_repeat"]').parents('tr').hide();
		$('label[for="' + cmsmasters_settings.shortname + '_footer_bg_pos"]').parents('tr').hide();
		$('label[for="' + cmsmasters_settings.shortname + '_footer_bg_attachment"]').parents('tr').hide();
	...
	/* General 'Footer' Tab Fields Change */
	$('#' + cmsmasters_settings.shortname + '_footer_bg_image_enable').on('change', function () { 
		if ($('#' + cmsmasters_settings.shortname + '_footer_bg_image_enable').is(':checked')) {
			$('#' + cmsmasters_settings.shortname + '_footer_bg_image').parents('tr').show();
			$('label[for="' + cmsmasters_settings.shortname + '_footer_bg_repeat"]').parents('tr').show();
			$('label[for="' + cmsmasters_settings.shortname + '_footer_bg_pos"]').parents('tr').show();
			$('label[for="' + cmsmasters_settings.shortname + '_footer_bg_attachment"]').parents('tr').show();
