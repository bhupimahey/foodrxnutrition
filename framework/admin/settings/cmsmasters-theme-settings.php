...
add_action('admin_menu', 'healthy_living_add_menu');
add_action('admin_init', 'healthy_living_register_settings');


healthy_living_locate_template(CMSMASTERS_SETTINGS . '/inc/cmsmasters-helper-functions.php', true);
healthy_living_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-general.php', true);
healthy_living_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-font.php', true);
healthy_living_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-color.php', true);
healthy_living_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-element.php', true);
healthy_living_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-single.php', true);
healthy_living_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-demo.php', true);


function healthy_living_get_settings() {
	$output = array();
	
	
	$page = healthy_living_get_admin_page();
	...
	case 'cmsmasters-settings':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'healthy-living';
		$cmsmasters_settings_page_title = esc_html__('Theme General Settings', 'healthy-living');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_general_sections_filter', healthy_living_options_general_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_general_fields_filter', healthy_living_options_general_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_general_tabs_filter', healthy_living_options_general_tabs());
	...
	case 'cmsmasters-settings' . '-font':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'healthy-living' . '_font';
		$cmsmasters_settings_page_title = esc_html__('Theme Fonts Settings', 'healthy-living');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_font_sections_filter', healthy_living_options_font_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_font_fields_filter', healthy_living_options_font_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_font_tabs_filter', healthy_living_options_font_tabs());
	...
	case 'cmsmasters-settings' . '-color':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'healthy-living' . '_color';
		$cmsmasters_settings_page_title = esc_html__('Theme Color Schemes', 'healthy-living');
		$cmsmasters_page_sections = healthy_living_options_color_sections();
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_color_fields_filter', healthy_living_options_color_fields(), $tab);
		$cmsmasters_page_tabs = healthy_living_options_color_tabs();
	...
	case 'cmsmasters-settings' . '-element':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'healthy-living' . '_element';
		$cmsmasters_settings_page_title = esc_html__('Theme Elements Settings', 'healthy-living');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_element_sections_filter', healthy_living_options_element_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_element_fields_filter', healthy_living_options_element_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_element_tabs_filter', healthy_living_options_element_tabs());
	...
	case 'cmsmasters-settings' . '-single':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'healthy-living' . '_single';
		$cmsmasters_settings_page_title = esc_html__('Theme Single Posts Settings', 'healthy-living');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_single_sections_filter', healthy_living_options_single_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_single_fields_filter', healthy_living_options_single_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_single_tabs_filter', healthy_living_options_single_tabs());
	...
	case 'cmsmasters-settings' . '-demo':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'healthy-living' . '_demo';
		$cmsmasters_settings_page_title = esc_html__('Theme Settings Import/Export', 'healthy-living');
		$cmsmasters_page_sections = healthy_living_options_demo_sections();
		$cmsmasters_page_fields = healthy_living_options_demo_fields();
		$cmsmasters_page_tabs = healthy_living_options_demo_tabs();
...
function healthy_living_create_settings_field($args = array()) {
	$defaults = array( 
		'id' => 		'default_field', 
		'title' => 		esc_html__('Default Field', 'healthy-living'), 
		'desc' => 		esc_html__('This is a default description.', 'healthy-living'), 
		'std' => 		'', 
		'type' => 		'text', 
...
function healthy_living_register_settings() {
	$settings_output = healthy_living_get_settings();
	...
	register_setting($cmsmasters_option_name, $cmsmasters_option_name, 'healthy_living_validate_options');
	
	
	if (!empty($settings_output['cmsmasters_page_sections'])) {
		foreach ($settings_output['cmsmasters_page_sections'] as $id => $title) {
			add_settings_section($id, $title, 'healthy_living_section_fn', __FILE__);
		}
	}
	...
	if (!empty($settings_output['cmsmasters_page_fields'])) {
		foreach ($settings_output['cmsmasters_page_fields'] as $option) {
			healthy_living_create_settings_field($option);
		}
	}
...
function healthy_living_settings_scripts() {
	...
	wp_localize_script('cmsmasters_theme_settings_js', 'cmsmasters_setting', array( 
		...
		'remove_sidebar' => 				esc_html__('Do you really want to remove this sidebar?', 'healthy-living'), 
		'remove_google_web_font' => 		esc_html__('Do you really want to remove this google web font?', 'healthy-living'), 
		'find' => 							esc_attr__('Find icons', 'healthy-living'), 
		'remove_icon' => 					esc_html__('Do you really want to remove this social icon?', 'healthy-living'), 
		'theme_uri' => 						get_template_directory_uri(), 
		'shortname' => 						'healthy-living', 
		'done' => 							esc_html__('All theme settings were imported successfully.', 'healthy-living'), 
		'fail' => 							esc_html__("Error on page!!!\nPlease reload page and try again.", 'healthy-living'), 
...
function healthy_living_add_menu() {
	$settings_output = healthy_living_get_settings();
	...
	$add_menu_p( 
		esc_attr__('Theme Settings', 'healthy-living'), 
		esc_attr__('Theme Settings', 'healthy-living'), 
		'manage_options', 
		'cmsmasters-settings', 
		'healthy_living_settings_page_fn', 
		'' 
	);
	...
	$cmsmasters_settings_general = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme General Settings', 'healthy-living'), 
		esc_attr__('General', 'healthy-living'), 
		'manage_options', 
		'cmsmasters-settings', 
		'healthy_living_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_general, 'healthy_living_settings_scripts');
	
	
	$cmsmasters_settings_font = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Fonts Settings', 'healthy-living'), 
		esc_attr__('Fonts', 'healthy-living'), 
		'manage_options', 
		'cmsmasters-settings' . '-font', 
		'healthy_living_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_font, 'healthy_living_settings_scripts');
	
	
	$cmsmasters_settings_color = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Color Schemes', 'healthy-living'), 
		esc_attr__('Colors', 'healthy-living'), 
		'manage_options', 
		'cmsmasters-settings' . '-color', 
		'healthy_living_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_color, 'healthy_living_settings_scripts');
	
	
	$cmsmasters_settings_element = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Elements Settings', 'healthy-living'), 
		esc_attr__('Elements', 'healthy-living'), 
		'manage_options', 
		'cmsmasters-settings' . '-element', 
		'healthy_living_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_element, 'healthy_living_settings_scripts');
	
	
	$cmsmasters_settings_single = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Single Posts Settings', 'healthy-living'), 
		esc_attr__('Single Posts', 'healthy-living'), 
		'manage_options', 
		'cmsmasters-settings' . '-single', 
		'healthy_living_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_single, 'healthy_living_settings_scripts');
	
	
	$cmsmasters_settings_demo = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Settings Import/Export', 'healthy-living'), 
		esc_attr__('Import/Export', 'healthy-living'), 
		'manage_options', 
		'cmsmasters-settings' . '-demo', 
		'healthy_living_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_demo, 'healthy_living_settings_scripts');
}


function healthy_living_section_fn($desc) {
	$tab = healthy_living_get_the_tab();
...
function healthy_living_settings_page_fn() {
	$settings_output = healthy_living_get_settings();
	$current_tab = healthy_living_get_the_tab();
	
	echo '<div class="wrap">';
	
	healthy_living_settings_page_header();
	...
	if ($current_tab != 'wpml') {
		...
		'<p class="submit-top">' . 
			(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit-top" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'healthy-living') . '" />' : '') . 
		'</p>';
		...
		echo '<p class="submit">' . 
				(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'healthy-living') . '" />' : (($current_tab == 'import') ? '<input name="import" type="button" class="button button-primary button-large cmsmasters-demo-import" value="' . esc_attr__('Import Settings', 'healthy-living') . '" />' : '')) . 
			'</p>' . 
		'</form>';
	} else {
		do_settings_sections(__FILE__);
...
function healthy_living_form_field_fn($args = array()) {
	extract($args);
	...
	case 'upload':
		...
		echo '<div class="cmsmasters_upload_parent cmsmasters_select_parent">' . 
			'<input type="button" id="cmsmasters_upload_' . $id . '_button" class="cmsmasters_upload_button button button-large" value="' . esc_attr__('Choose Image', 'healthy-living') . '" data-title="' . esc_attr__('Choose Image', 'healthy-living') . '" data-button="' . esc_attr__('Insert Image', 'healthy-living') . '" data-id="cmsmasters-media-select-frame-' . $id . '" data-classes="media-frame cmsmasters-media-select-frame' . ((!isset($description)) ? ' cmsmasters-frame-no-description' : '') . ((!isset($caption)) ? ' cmsmasters-frame-no-caption' : '') . ((!isset($align)) ? ' cmsmasters-frame-no-align' : '') . ((!isset($link)) ? ' cmsmasters-frame-no-link' : '') . ((!isset($size)) ? ' cmsmasters-frame-no-size' : '') . '" data-library="image" data-type="' . $frame . '"' . (($frame == 'post') ? ' data-state="insert"' : '') . ' data-multiple="' . $multiple . '" />' . 
			'<div class="cmsmasters_upload"' . (($image != '') ? ' style="display:block;"' : '') . '>' . 
				'<img src="' . (($image != '') ? $image : '') . '" class="cmsmasters_preview_image" />' . 
				'<a href="#" class="cmsmasters_upload_cancel admin-icon-remove" title="' . esc_attr__('Remove', 'healthy-living') . '"></a>' . 
			'</div>' . 
	...
	case 'typorgaphy':
		...
		if ($system_font) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (healthy_living_system_fonts_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_system_font'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_system_font">' . esc_html__('System Font', 'healthy-living') . '</label>' . 
			'</div>';
		}
			...
			echo '<div class="cmsmasters_admin_block">' . 
				'<select class="select" id="' . $id . '_google_font" name="' . $cmsmasters_option_name . '[' . $id . '_google_font]">';
					...
					if (!empty($cmsmasters_fonts_list['local'])) {
						echo '<optgroup label="' . esc_attr__('Local Fonts', 'healthy-living') . '">';
					...
					if (!empty($cmsmasters_fonts_list['web'])) {
						echo '<optgroup label="' . esc_attr__('Google Web Fonts', 'healthy-living') . '">';
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_google_font">' . esc_html__('Google Font', 'healthy-living') . '</label>' . 
			'</div>';
		}
		...
		if ($font_size) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_font_size_number">' . esc_html__('Font Size', 'healthy-living') . ' <em>(' . esc_html__('in pixels', 'healthy-living') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($line_height) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_line_height_number">' . esc_html__('Line Height', 'healthy-living') . ' <em>(' . esc_html__('in pixels', 'healthy-living') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($font_weight) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_weight">' . esc_html__('Font Weight', 'healthy-living') . '</label>' . 
			'</div>';
		}
		...
		if ($font_style) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_style">' . esc_html__('Font Style', 'healthy-living') . '</label>' . 
			'</div>';
		}
		...
		if ($text_transform) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (healthy_living_text_transform_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_text_transform'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_transform">' . esc_html__('Text Transform', 'healthy-living') . '</label>' . 
			'</div>';
		}
		...
		if ($text_decoration) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (healthy_living_text_decoration_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_text_decoration'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_decoration">' . esc_html__('Text Decoration', 'healthy-living') . '</label>' . 
			'</div>';
		}
	...
	case 'sidebar':
		...
		'<div class="sidebar_management">' . 
			'<p>' . 
				...
				'<input class="button" type="button" id="add_sidebar" value="' . esc_attr__('Add Sidebar', 'healthy-living') . '" />' . 
			'</p>' . 
			'<div></div>' . 
			'<ul>';
	...
	case 'google_web_fonts':
		...
		'<div class="google_web_fonts_manager">' . 
				...
				if (isset($options[$id]) && is_array($options[$id])) {
					...
					foreach($options[$id] as $font) {
						...
						echo '<div class="google_web_fonts_manager_item">' . 
							'<input class="all-options" type="text" id="google_web_font_family" placeholder="' . esc_attr__('Font Family (for example: Roboto Slab)', 'healthy-living') . '" name="' . $cmsmasters_option_name . '[' . $id . '_-_' . $i . '_family]" value="' . esc_attr($font[1]) . '" />' . 
							'<input class="regular-text" type="text" id="google_web_font_style" placeholder="' . esc_attr__('Font Style (for example: Roboto+Slab:100,300,400,700)', 'healthy-living') . '" name="' . $cmsmasters_option_name . '[' . $id . '_-_' . $i . '_style]" value="' . esc_attr($font[0]) . '" />' . 
			...
			'<input class="button" type="button" id="add_google_web_font" value="' . esc_attr__('Add Font', 'healthy-living') . '" data-font-family-label="' . esc_attr__('Font Family (for example: Roboto Slab)', 'healthy-living') . '" data-font-style-label="' . esc_attr__('Font Style (for example: Roboto+Slab:100,300,400,700)', 'healthy-living') . '" data-option-name="' . $cmsmasters_option_name . '[' . $id . '_-_" />' . 
		'</div>';
	...
	case 'social':
		...
		'<div class="icon_management">' . 
			'<p>' . 
				...
				'<input id="' . $id . '_button" class="cmsmasters_icon_choose_button button" type="button" value="' . esc_attr__('Choose icon', 'healthy-living') . '" />' . 
				'<a href="#" class="cmsmasters_remove_icon admin-icon-remove" title="' . esc_attr__('Cancel changes', 'healthy-living') . '"></a>' . 
			'</p>' . 
			'<span class="cl"><br /></span>' . 
			'<span class="icon_upload_link" style="display:none;">' . 
				'<label for="new_icon_color">' . 
					'<span class="cmsmasters_col_label">' . esc_html__('Icon Color', 'healthy-living') . '</span>' . 
				...
				'<label for="new_icon_hover">' . 
					'<span class="cmsmasters_col_label">' . esc_html__('Icon Hover Color', 'healthy-living') . '<br /><em>' . esc_html__('if not selected - Icon Color will be used', 'healthy-living') . '</em></span>' . 
				...
				'<label for="new_icon_link">' . 
					...
					esc_html__('Icon Link', 'healthy-living') . 
				'</label>' . 
				'<label for="new_icon_title">' . 
					'<input class="all-options" type="text" id="new_icon_title" /> ' . 
					esc_html__('Icon Title', 'healthy-living') . 
				'</label>' . 
				'<label for="new_icon_target">' . 
					'<input type="checkbox" id="new_icon_target" value="true" /> ' . 
					esc_html__('Open link in a new tab/window?', 'healthy-living') . 
				'</label>' . 
			'</span>' . 
			'<span class="cl"></span>' . 
			'<input class="button button-primary" type="button" id="add_icon" value="' . esc_attr__('Add Icon', 'healthy-living') . '" />' . 
			'<input class="button button-primary" type="button" id="edit_icon" value="' . esc_attr__('Save Icon', 'healthy-living') . '" />' . 
			'<ul>';
			...
			if (isset($options[$id]) && is_array($options[$id])) {
				foreach($options[$id] as $icon) {
					...
					echo '<li>' . 
						...
						'</div>' . 
						'<a href="#" class="icon_del admin-icon-remove" title="' . esc_attr__('Remove', 'healthy-living') . '"></a> ' . 
...
function healthy_living_validate_options($input) {
	$valid_input = array();
	...
	foreach ($options as $option) {
		...
		case 'text':
			...
			case 'numeric':
				...
				$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Expecting a Numeric value!', 'healthy-living');
				
				if (is_numeric($input[$option['id']]) == false) {
					add_settings_error(
						$option['id'],
						'healthy-living' . '_txt_numeric_error',
						esc_html__('Expecting a Numeric value! Please fix.', 'healthy-living'),
						'error'
					);
				}
			...
			case 'multinumeric':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) == 1) ? $input[$option['id']] : esc_html__('Expecting comma separated numeric values', 'healthy-living');
				} else {
				...
				if ($input[$option['id']] != '' && preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) != 1) {
					add_settings_error(
						$option['id'],
						'healthy-living' . '_txt_multinumeric_error',
						esc_html__('Expecting comma separated numeric values! Please fix.','healthy-living'),
						'error'
					);
				}
			...
			case 'email':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (is_email($input[$option['id']]) !== false) ? $input[$option['id']] : esc_html__('Invalid email! Please re-enter!', 'healthy-living');
				} elseif ($input[$option['id']] == '') {
					$valid_input[$option['id']] = esc_html__('This setting field cannot be empty! Please enter a valid email address.', 'healthy-living');
				}
				
				if (is_email($input[$option['id']]) == false || $input[$option['id']] == '') {
					add_settings_error(
						$option['id'],
						'healthy-living' . '_txt_email_error',
						esc_html__('Please enter a valid email address.', 'healthy-living'),
						'error'
					);
				}
		...
		case 'number':
			$input[$option['id']] = trim($input[$option['id']]);
			$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Number!', 'healthy-living');
...
function healthy_living_theme_admin_bar_render() {
	global $wp_admin_bar;
	
	
	$wp_admin_bar->add_menu(array( 
		'id' => 'healthy-living' . '_options', 
		'title' => esc_attr__('Theme Settings', 'healthy-living'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings')) 
	));
	
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'healthy-living' . '_options', 
		'id' => 'healthy-living' . '_theme_settings', 
		'title' => esc_attr__('General', 'healthy-living'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings')) 
	));
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'healthy-living' . '_options', 
		'id' => 'healthy-living' . '_theme_settings_font', 
		'title' => esc_attr__('Fonts', 'healthy-living'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings-font')) 
	));
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'healthy-living' . '_options', 
		'id' => 'healthy-living' . '_theme_settings_color', 
		'title' => esc_attr__('Colors', 'healthy-living'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings-color')) 
	));
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'healthy-living' . '_options', 
		'id' => 'healthy-living' . '_theme_settings_element', 
		'title' => esc_attr__('Elements', 'healthy-living'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings-element')) 
	));
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'healthy-living' . '_options', 
		'id' => 'healthy-living' . '_theme_settings_single', 
		'title' => esc_attr__('Single', 'healthy-living'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings-single')) 
	));
}

add_action('wp_before_admin_bar_render', 'healthy_living_theme_admin_bar_render');


function healthy_living_show_msg($message, $msgclass = 'info') {
	echo '<div id="message" class="' . $msgclass . '">' . $message . '</div>';
}


function healthy_living_admin_msgs() {
	global $pagenow;
	...
	if ($pagenow == 'admin.php' && current_user_can('manage_options') && $cmsmasters_settings_pg !== false && !empty($set_errors)) {
		if ($set_errors[0]['code'] == 'settings_updated' && isset($_GET['settings-updated'])) {
			healthy_living_show_msg('<p><strong>' . $set_errors[0]['message'] . '</strong></p>', 'updated');
		} else {
			foreach ($set_errors as $set_error) {
				healthy_living_show_msg('<p class="setting-error-message" title="' . esc_attr($set_error['setting']) . '">' . $set_error['message'] . '</p>', 'error');
			}
		}
	}
}

add_action('admin_notices', 'healthy_living_admin_msgs');


function healthy_living_add_global_options() {
	$cmsmasters_option_names = array( 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_general', 
			healthy_living_options_general_fields('general') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_bg', 
			healthy_living_options_general_fields('bg') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_header', 
			healthy_living_options_general_fields('header') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_content', 
			healthy_living_options_general_fields('content') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_footer', 
			healthy_living_options_general_fields('footer') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_font_content', 
			healthy_living_options_font_fields('content') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_font_link', 
			healthy_living_options_font_fields('link') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_font_nav', 
			healthy_living_options_font_fields('nav') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_font_heading', 
			healthy_living_options_font_fields('heading') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_font_other', 
			healthy_living_options_font_fields('other') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_font_google', 
			healthy_living_options_font_fields('google') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_element_sidebar', 
			healthy_living_options_element_fields('sidebar') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_element_icon', 
			healthy_living_options_element_fields('icon') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_element_lightbox', 
			healthy_living_options_element_fields('lightbox') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_element_sitemap', 
			healthy_living_options_element_fields('sitemap') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_element_error', 
			healthy_living_options_element_fields('error') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_element_code', 
			healthy_living_options_element_fields('code') 
		), 
		array( 
		...
		array( 
			...
			healthy_living_options_single_fields('post') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_single_project', 
			healthy_living_options_single_fields('project') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_single_profile', 
			healthy_living_options_single_fields('profile') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-living' . '_single_campaign', 
			healthy_living_options_single_fields('campaign') 
		) 
	);
	...
	foreach (healthy_living_all_color_schemes_list() as $key => $value) {
		array_push($cmsmasters_option_names, array( 
			'cmsmasters_options_' . 'healthy-living' . '_color_' . $key, 
			healthy_living_options_color_fields($key) 
		));
	}
		...
		if ($cmsmasters_option_name[1] !== '') {
			foreach ($cmsmasters_option_name[1] as $selected_option) {
				if ( 
					...
					$selected_option['id'] !== 'healthy-living' . '_social_icons' && 
					$selected_option['id'] !== 'healthy-living' . '_google_web_fonts' 
				) {
...
function healthy_living_get_global_options() {
	...
	foreach (healthy_living_all_color_schemes_list() as $key => $value) {
		array_push($cmsmasters_option_names, 'cmsmasters_options_' . 'healthy-living' . '_color_' . $key);
	}
