...
function cmsmasters_enable_more_buttons($buttons) {
...
add_filter('mce_buttons_3', 'cmsmasters_enable_more_buttons');



function cmsmasters_change_mce_blockformats_buttons($initArray) {
...
add_filter('tiny_mce_before_init', 'cmsmasters_change_mce_blockformats_buttons');
